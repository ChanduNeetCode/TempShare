        ...
        style={
          item.isResult
            ? [
              ...
              [isRadioButton && styles.radioButtonOnStyles],
              searchRenderTouchableActiveStyle,
            ]
            : [
              styles.searchRenderTouchableContainer,
              [isRadioButton && styles.radioButtonOffStyles],
              searchRenderTouchContainerStyle,
            ]
        }>
  ...
  return (
    <View
      ...
      <View style={[styles.container, style]}>
        {isSearch && (
          <View style={[styles.searchInputViewContainer, searchInputContainer]}>
            {searchImage}
            <TextInput
              style={
        ...
        <>
          ...
          {(isListIndexLetter && !(changeText.length > 0)) && (
            <ListLetterIndex
