...
export default class Agenda extends Component<AgendaProps, State> {
  ...
  static propTypes: {
    ...
    style: PropTypes.Requireable<
      NonNullable<number | object | null | undefined>
    >;
    ...
    markedDates?:
      | React.Validator<import('../types').MarkedDates | null | undefined>
      | undefined;
    ...
    onDayPress?:
      | React.Validator<((date: DateData) => void) | null | undefined>
      | undefined;
    onDayLongPress?:
      | React.Validator<((date: DateData) => void) | null | undefined>
      | undefined;
    ...
    onVisibleMonthsChange?:
      | React.Validator<((months: DateData[]) => void) | null | undefined>
      | undefined;
    disableMonthChange?:
      | React.Validator<boolean | null | undefined>
      | undefined;
    ...
    headerStyle?:
      | React.Validator<import('react-native').StyleProp<ViewStyle>>
      | undefined;
    ...
    addMonth?:
      | React.Validator<((num: number) => void) | null | undefined>
      | undefined;
    ...
    renderArrow?:
      | React.Validator<
          | ((direction: import('../types').Direction) => React.ReactNode)
          | null
          | undefined
        >
      | undefined;
    onPressArrowLeft?:
      | React.Validator<
          | ((method: () => void, month?: XDate | undefined) => void)
          | null
          | undefined
        >
      | undefined;
    ...
    arrowsHitSlop?:
      | React.Validator<
          number | import('react-native').Insets | null | undefined
        >
      | undefined;
    ...
    isMonthDropDown?: React.Validator<boolean | null | undefined> | undefined;
    doneText?: string;
    doneStyle?: ViewStyle;
    isMonthTouchDisable?: React.Validator<boolean | null | undefined> | undefined;
    disabledDaysIndexes?:
      | React.Validator<number[] | null | undefined>
      | undefined;
    renderHeader?:
      | React.Validator<
          ((date?: XDate | undefined) => React.ReactNode) | null | undefined
        >
      | undefined;
    customHeaderTitle?:
      | React.Validator<JSX.Element | null | undefined>
      | undefined;
    ...
    importantForAccessibility?:
      | React.Validator<
          'auto' | 'yes' | 'no' | 'no-hide-descendants' | null | undefined
        >
      | undefined;
    ...
    dayComponent?:
      ...
      | undefined;
    state?:
      | React.Validator<import('../types').DayState | null | undefined>
      | undefined;
    marking?:
      | React.Validator<
          import('../calendar/day/marking').MarkingProps | null | undefined
        >
      | undefined;
    markingType?:
      | React.Validator<import('../types').MarkingTypes | null | undefined>
      | undefined;
    onPress?:
      | React.Validator<
          ((date?: DateData | undefined) => void) | null | undefined
        >
      | undefined;
    onLongPress?:
      | React.Validator<
    ...
    hitSlop?:
      | React.Validator<import('react-native').Insets | null | undefined>
      | undefined;
    id?: React.Validator<string | null | undefined> | undefined;
    onLayout?:
      | React.Validator<((event: LayoutChangeEvent) => void) | null | undefined>
      | undefined;
    pointerEvents?:
      | React.Validator<
          'auto' | 'none' | 'box-none' | 'box-only' | null | undefined
        >
      | undefined;
    ...
    tvParallaxProperties?:
      | React.Validator<
          import('react-native').TVParallaxProperties | null | undefined
        >
      | undefined;
    ...
    accessibilityRole?:
      | React.Validator<
          import('react-native').AccessibilityRole | null | undefined
        >
      | undefined;
    accessibilityState?:
      | React.Validator<
          import('react-native').AccessibilityState | null | undefined
        >
      | undefined;
    'aria-busy'?: React.Validator<boolean | null | undefined> | undefined;
    'aria-checked'?:
      | React.Validator<boolean | 'mixed' | null | undefined>
      | undefined;
    ...
    accessibilityValue?:
      | React.Validator<
          import('react-native').AccessibilityValue | null | undefined
        >
      | undefined;
    ...
    'aria-live'?:
      | React.Validator<'polite' | 'assertive' | 'off' | null | undefined>
      | undefined;
    'aria-modal'?: React.Validator<boolean | null | undefined> | undefined;
    role?:
      | React.Validator<import('react-native').Role | null | undefined>
      | undefined;
    accessibilityLiveRegion?:
      | React.Validator<'none' | 'polite' | 'assertive' | null | undefined>
      | undefined;
    accessibilityLabelledBy?:
      | React.Validator<string | string[] | null | undefined>
      | undefined;
    accessibilityViewIsModal?:
      | React.Validator<boolean | null | undefined>
      | undefined;
    onAccessibilityEscape?:
      | React.Validator<(() => void) | null | undefined>
      | undefined;
    onAccessibilityTap?:
      | React.Validator<(() => void) | null | undefined>
      | undefined;
    ...
    keyboardShouldPersistTaps?:
      | React.Validator<
          boolean | 'never' | 'always' | 'handled' | null | undefined
        >
      | undefined;
    ...
    keyExtractor?:
      | React.Validator<
          ((item: any, index: number) => string) | null | undefined
        >
      | undefined;
    ...
    ItemSeparatorComponent?:
      | React.Validator<React.ComponentType<any> | null | undefined>
      | undefined;
    ListEmptyComponent?:
      | React.Validator<
    ...
    disableVirtualization?:
      ...
      | undefined;
    getItem?:
      | React.Validator<((data: any, index: number) => any) | null | undefined>
      | undefined;
    getItemCount?:
      | React.Validator<((data: any) => number) | null | undefined>
      | undefined;
    ...
    viewabilityConfigCallbackPairs?:
      | React.Validator<
          | import('react-native').ViewabilityConfigCallbackPairs
          | null
          | undefined
        >
      | undefined;
    ...
    contentContainerStyle?:
      ...
      | undefined;
    decelerationRate?:
      | React.Validator<number | 'normal' | 'fast' | null | undefined>
      | undefined;
    invertStickyHeaders?:
      | React.Validator<boolean | null | undefined>
      | undefined;
    keyboardDismissMode?:
      | React.Validator<'none' | 'interactive' | 'on-drag' | null | undefined>
      | undefined;
    onContentSizeChange?:
      | React.Validator<((w: number, h: number) => void) | null | undefined>
      | undefined;
    ...
    contentInset?:
      ...
      | undefined;
    contentOffset?:
      | React.Validator<import('react-native').PointProp | null | undefined>
      | undefined;
    contentInsetAdjustmentBehavior?:
      | React.Validator<
          'never' | 'always' | 'automatic' | 'scrollableAxes' | null | undefined
        >
      | undefined;
    directionalLockEnabled?:
      ...
      | undefined;
    indicatorStyle?:
      | React.Validator<'white' | 'default' | 'black' | null | undefined>
      | undefined;
    ...
    snapToAlignment?:
      | React.Validator<'center' | 'end' | 'start' | null | undefined>
      | undefined;
    onScrollToTop?:
      | React.Validator<
    ...
    endFillColor?:
      | React.Validator<import('react-native').ColorValue | null | undefined>
      | undefined;
    scrollPerfTag?: React.Validator<string | null | undefined> | undefined;
    overScrollMode?:
      | React.Validator<'auto' | 'never' | 'always' | null | undefined>
      | undefined;
    nestedScrollEnabled?:
      | React.Validator<boolean | null | undefined>
      | undefined;
    ...
    context?:
      | React.Validator<
          | import('../expandableCalendar/Context').CalendarContextProps
          | null
          | undefined
        >
      | undefined;
