...
export declare function shouldUpdate(
  props: any,
  newProps: any,
  paths: string[],
): boolean;
export declare function extractComponentProps(
  component: any,
  props: any,
  ignoreProps?: string[],
): any;
...
export declare function extractDayProps(props: CalendarProps): {
  ...
  theme: import('./types').Theme | undefined;
  onPress:
  | ((date?: import('./types').DateData | undefined) => void)
  | undefined;
  onLongPress:
  | ((date?: import('./types').DateData | undefined) => void)
  | undefined;
...
export declare function extractHeaderProps(props: CalendarProps): {
  ...
  renderArrow:
  | ((direction: import('./types').Direction) => import('react').ReactNode)
  | undefined;
  onPressArrowLeft:
  | ((method: () => void, month?: import('xdate') | undefined) => void)
  | undefined;
  onPressArrowRight:
  | ((method: () => void, month?: import('xdate') | undefined) => void)
  | undefined;
  ...
  isMonthDropDown: boolean | undefined;
  doneText?: string;
  doneStyle?: ViewStyle;
  isMonthTouchDisable: boolean | undefined;
  disabledDaysIndexes: number[] | undefined;
  renderHeader:
  | ((date?: import('xdate') | undefined) => import('react').ReactNode)
  | undefined;
...
export declare function extractCalendarProps(props: CalendarListProps): {
  ...
  | ((months: import('./types').DateData[]) => void)
  | undefined;
  ...
  columnWrapperStyle?: import('react-native').StyleProp<
    import('react-native').ViewStyle
  >;
  extraData?: any;
  getItemLayout?:
  ...
  | null
  | undefined;
  ListFooterComponentStyle?: import('react-native').StyleProp<
    import('react-native').ViewStyle
  >;
  ListHeaderComponent?:
  | import('react').ComponentType<any>
  ...
  | null
  | undefined;
  ListHeaderComponentStyle?: import('react-native').StyleProp<
    import('react-native').ViewStyle
  >;
...
export declare function extractCalendarListProps(props: AgendaProps): {
  ...
  doneText?: string;
  doneStyle?: ViewStyle;
  isMonthTouchDisable?: number[] | undefined;
  disabledDaysIndexes?: number[] | undefined;
  renderHeader?:
  | ((date?: import('xdate') | undefined) => import('react').ReactNode)
  | undefined;
...
export declare function extractReservationListProps(props: AgendaProps): {
  ...
  onDayChange:
  | (((day: import('xdate')) => void) &
    ((data: import('./types').DateData) => void))
  | undefined;
  ...
  | ((item: import('./types').DayAgenda, index: number) => string)
  | undefined;
  ...
  rowHasChanged:
  | ((
    a: import('./types').AgendaEntry,
    b: import('./types').AgendaEntry,
  ) => boolean)
  | undefined;
  renderDay:
  | ((
  ...
  renderItem:
  | ((
    reservation: import('./types').AgendaEntry,
    isFirst: boolean,
  ) => JSX.Element | import('react').Component<{}, {}, any>)
  | undefined;
  renderEmptyDate:
  | ((
    date?: import('xdate') | undefined,
